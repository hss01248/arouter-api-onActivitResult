...
public class _ARouter2 {
    ...
    private volatile static _ARouter2 instance = null;
    ...
    protected static _ARouter2 getInstance() {
        if (!hasInit) {
            throw new InitException("ARouterCore::Init::Invoke init(context) first!");
        } else {
            if (instance == null) {
                synchronized (_ARouter2.class) {
                    if (instance == null) {
                        instance = new _ARouter2();
                    }
                }
            }
            return instance;
     ...
     * @param callback    cb
     */
    protected Object navigation(final Context context, final Postcard postcard, final int requestCode, final NavigationCallback2 callback) {
    ...
    private Object _navigation(final Context context, final Postcard postcard, final int requestCode, final NavigationCallback2 callback) {
        ...
        switch (postcard.getType()) {
            case ACTIVITY:
                ...
                runInMainThread(new Runnable() {
                    @Override
                    public void run() {
                        startActivity(requestCode, finalCurrentContext, intent, postcard, callback);
                    }
                });
     ...
     * @see ActivityCompat
     */
    private void startActivity(int requestCode, Context currentContext, Intent intent, Postcard postcard, NavigationCallback2 callback) {
